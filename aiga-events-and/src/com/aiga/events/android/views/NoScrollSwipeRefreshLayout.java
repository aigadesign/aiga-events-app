 ...
 *
 * Modified on 2 Apr 2014 by Deloitte Digital
 * www.deloittedigital.com
 * 
 * Modification removes the overscroll behavior from the child view, as is 
 * present in the original SwipeRefreshLayout class. 
 *
 ...
 * </p>
 */
public class NoScrollSwipeRefreshLayout extends ViewGroup {
	private static final long RETURN_TO_ORIGINAL_POSITION_TIMEOUT = 300;
	private static final float ACCELERATE_INTERPOLATION_FACTOR = 1.5f;
	private static final float DECELERATE_INTERPOLATION_FACTOR = 2f;
	private static final float PROGRESS_BAR_HEIGHT = 4;
	private static final float MAX_SWIPE_DISTANCE_FACTOR = .6f;
	private static final int REFRESH_TRIGGER_DISTANCE = 220;	// 66% greater than default
	 ...
	 * @param context
	 */
	public NoScrollSwipeRefreshLayout(Context context) {
		this(context, null);
	}
